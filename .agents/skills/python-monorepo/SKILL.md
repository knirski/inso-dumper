...
description: Python monorepos with uv workspaces, package layouts, namespace packages, Docker, and CI. Use for uv workspace setup or troubleshooting, explicit workspace dependencies, multi-package pyproject.toml design, package build/publish, or containerizing Python workspace applications. For standalone uv tooling, use python-build-tools.
